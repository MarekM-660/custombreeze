classik // This file is generated by kconfig_compiler_kf5 from breeze.kcfg.
...
StyleConfigData::StyleConfigData()
    : KConfigSkeleton(QStringLiteral("classikrc"))
{
    ...
    itemStackedWidgetTransitionsEnabled =
        new KConfigSkeleton::ItemBool(currentGroup(), QStringLiteral("StackedWidgetTransitionsEnabled"), mStackedWidgetTransitionsEnabled, false);
    ...
    itemProgressBarBusyStepDuration =
        new KConfigSkeleton::ItemInt(currentGroup(), QStringLiteral("ProgressBarBusyStepDuration"), mProgressBarBusyStepDuration, 800);
    addItem(itemProgressBarBusyStepDuration, QStringLiteral("ProgressBarBusyStepDuration"));
    KConfigSkeleton::ItemInt *itemScrollBarTopBottomMargins;
    itemScrollBarTopBottomMargins = new KConfigSkeleton::ItemInt(currentGroup(), QStringLiteral("ScrollBarTopBottomMargins"), mScrollBarTopBottomMargins, 4);
    itemScrollBarTopBottomMargins->setMinValue(0);
    itemScrollBarTopBottomMargins->setMaxValue(20);
    addItem(itemScrollBarTopBottomMargins, QStringLiteral("ScrollBarTopBottomMargins"));
    KConfigSkeleton::ItemInt *itemScrollBarAddLineButtons;
    itemScrollBarAddLineButtons = new KConfigSkeleton::ItemInt(currentGroup(), QStringLiteral("ScrollBarAddLineButtons"), mScrollBarAddLineButtons, 1);
    ...
    itemScrollBarSubLineButtons = new KConfigSkeleton::ItemInt(currentGroup(), QStringLiteral("ScrollBarSubLineButtons"), mScrollBarSubLineButtons, 1);
    addItem(itemScrollBarSubLineButtons, QStringLiteral("ScrollBarSubLineButtons"));
    KConfigSkeleton::ItemInt *itemScrollBarTopOneButtonSpacing;
    itemScrollBarTopOneButtonSpacing =
        new KConfigSkeleton::ItemInt(currentGroup(), QStringLiteral("ScrollBarTopOneButtonSpacing"), mScrollBarTopOneButtonSpacing, -3);
    itemScrollBarTopOneButtonSpacing->setMinValue(-10);
    itemScrollBarTopOneButtonSpacing->setMaxValue(10);
    addItem(itemScrollBarTopOneButtonSpacing, QStringLiteral("ScrollBarTopOneButtonSpacing"));
    KConfigSkeleton::ItemInt *itemScrollBarBottomOneButtonSpacing;
    itemScrollBarBottomOneButtonSpacing =
        new KConfigSkeleton::ItemInt(currentGroup(), QStringLiteral("ScrollBarBottomOneButtonSpacing"), mScrollBarBottomOneButtonSpacing, -3);
    itemScrollBarBottomOneButtonSpacing->setMinValue(-10);
    itemScrollBarBottomOneButtonSpacing->setMaxValue(10);
    addItem(itemScrollBarBottomOneButtonSpacing, QStringLiteral("ScrollBarBottomOneButtonSpacing"));
    KConfigSkeleton::ItemInt *itemScrollBarTopTwoButtonSpacing;
    itemScrollBarTopTwoButtonSpacing =
        new KConfigSkeleton::ItemInt(currentGroup(), QStringLiteral("ScrollBarTopTwoButtonSpacing"), mScrollBarTopTwoButtonSpacing, 0);
    itemScrollBarTopTwoButtonSpacing->setMinValue(-10);
    itemScrollBarTopTwoButtonSpacing->setMaxValue(10);
    addItem(itemScrollBarTopTwoButtonSpacing, QStringLiteral("ScrollBarTopTwoButtonSpacing"));
    KConfigSkeleton::ItemInt *itemScrollBarBottomTwoButtonSpacing;
    itemScrollBarBottomTwoButtonSpacing =
        new KConfigSkeleton::ItemInt(currentGroup(), QStringLiteral("ScrollBarBottomTwoButtonSpacing"), mScrollBarBottomTwoButtonSpacing, 0);
    itemScrollBarBottomTwoButtonSpacing->setMinValue(-10);
    itemScrollBarBottomTwoButtonSpacing->setMaxValue(10);
    addItem(itemScrollBarBottomTwoButtonSpacing, QStringLiteral("ScrollBarBottomTwoButtonSpacing"));
    KConfigSkeleton::ItemBool *itemScrollBarAutoHideArrows;
    itemScrollBarAutoHideArrows = new KConfigSkeleton::ItemBool(currentGroup(), QStringLiteral("ScrollBarAutoHideArrows"), mScrollBarAutoHideArrows, true);
    addItem(itemScrollBarAutoHideArrows, QStringLiteral("ScrollBarAutoHideArrows"));
    KConfigSkeleton::ItemInt *itemScrollBarSliderThicknessMouseOver;
    itemScrollBarSliderThicknessMouseOver =
        new KConfigSkeleton::ItemInt(currentGroup(), QStringLiteral("ScrollBarSliderThicknessMouseOver"), mScrollBarSliderThicknessMouseOver, 8);
    itemScrollBarSliderThicknessMouseOver->setMinValue(1);
    itemScrollBarSliderThicknessMouseOver->setMaxValue(50);
    addItem(itemScrollBarSliderThicknessMouseOver, QStringLiteral("ScrollBarSliderThicknessMouseOver"));
    KConfigSkeleton::ItemInt *itemScrollBarSliderThicknessMouseNotOverPercent;
    itemScrollBarSliderThicknessMouseNotOverPercent = new KConfigSkeleton::ItemInt(currentGroup(),
                                                                                   QStringLiteral("ScrollBarSliderThicknessMouseNotOverPercent"),
                                                                                   mScrollBarSliderThicknessMouseNotOverPercent,
                                                                                   75);
    itemScrollBarSliderThicknessMouseNotOverPercent->setMinValue(1);
    itemScrollBarSliderThicknessMouseNotOverPercent->setMaxValue(100);
    addItem(itemScrollBarSliderThicknessMouseNotOverPercent, QStringLiteral("ScrollBarSliderThicknessMouseNotOverPercent"));
    KConfigSkeleton::ItemInt *itemScrollBarSliderPadding;
    itemScrollBarSliderPadding = new KConfigSkeleton::ItemInt(currentGroup(), QStringLiteral("ScrollBarSliderPadding"), mScrollBarSliderPadding, 5);
    itemScrollBarSliderPadding->setMinValue(0);
    itemScrollBarSliderPadding->setMaxValue(20);
    addItem(itemScrollBarSliderPadding, QStringLiteral("ScrollBarSliderPadding"));
    KConfigSkeleton::ItemInt *itemScrollBarMinSliderHeight;
    itemScrollBarMinSliderHeight = new KConfigSkeleton::ItemInt(currentGroup(), QStringLiteral("ScrollBarMinSliderHeight"), mScrollBarMinSliderHeight, 36);
    itemScrollBarMinSliderHeight->setMinValue(5);
    itemScrollBarMinSliderHeight->setMaxValue(80);
    addItem(itemScrollBarMinSliderHeight, QStringLiteral("ScrollBarMinSliderHeight"));

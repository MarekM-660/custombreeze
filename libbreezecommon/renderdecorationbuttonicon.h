...
protected:
    ...
    /**
     * @param isHovered Checks if button is currently hovered
     * @param isInactive Checks if button is currently inactive
     * @param isChecked Checks if button is currently checked or not
     */

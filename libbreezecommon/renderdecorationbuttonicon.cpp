                                                                                            ...
                                                                                            const QPointF &deviceOffsetTitleBarTopLeftToIconTopLeft)
{
    ...
    case InternalSettings::StyleMacOS:
        return std::unique_ptr<RenderDecorationButtonIcon18By18>(
            new RenderStyleMacOS18By18(internalSettings, painter, fromKstyle, boldButtonIcons, devicePixelRatio, deviceOffsetTitleBarTopLeftToIconTopLeft));
    case InternalSettings::StyleSweet:
        return std::unique_ptr<RenderDecorationButtonIcon18By18>(
            new RenderStyleSweet18By18(internalSettings, painter, fromKstyle, boldButtonIcons, devicePixelRatio, deviceOffsetTitleBarTopLeftToIconTopLeft));
